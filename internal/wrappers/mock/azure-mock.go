...
func (g AzureMockWrapper) GetProjects( url string, organizationName string, token string) (wrappers.AzureRootProject, error) {
...
func (g AzureMockWrapper) GetRepositories(url string, organizationName string, projectName string, token string) (wrappers.AzureRootRepo, error) {
