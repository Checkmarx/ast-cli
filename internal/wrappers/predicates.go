...
type ResultsPredicatesWrapper interface {
	...
	GetAllPredicatesForSimilarityID(similarityID string, projectID string, scannerType string) (*PredicatesCollectionResponseModel, *resultsHelpers.WebError, error) //nolint:gocritic
}
