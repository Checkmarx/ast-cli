...
func TestDetectRepositoryPrivacy_FallbackToSystemGit(t *testing.T) {
	...
	// When detectRepositoryPrivacy is called, it should try go-git first (succeeds)
	// then isPrivateByURL will be called. Since example.com is not a real SCM,
	// the function should handle it gracefully and default to private=true
