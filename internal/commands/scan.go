...
func NewScanCommand(
	...
	scanCmd := &cobra.Command{
		Use:   "scan",
		Short: "Manage scans",
		Long:  "The scan command enables the ability to manage scans in CxONE.",
...
func scanTagsSubCommand(scansWrapper wrappers.ScansWrapper) *cobra.Command {
	tagsCmd := &cobra.Command{
		...
		Long:  "The tags command enables the ability to provide a list of all the available tags in CxONE.",
		Example: heredoc.Doc(
			`
			$ cx scan tags
		`,
...
func scanCancelSubCommand(scansWrapper wrappers.ScansWrapper) *cobra.Command {
	cancelScanCmd := &cobra.Command{
		...
		Long:  "The cancel command enables the ability to cancel one or more running scans in CxONE.",
		Example: heredoc.Doc(
			`
...
func scanWorkflowSubCommand(scansWrapper wrappers.ScansWrapper) *cobra.Command {
	workflowScanCmd := &cobra.Command{
		...
		Long:  "The workflow command enables the ability to provide information about a requested scan workflow in CxONE.",
		Example: heredoc.Doc(
			`
...
func scanShowSubCommand(scansWrapper wrappers.ScansWrapper) *cobra.Command {
	showScanCmd := &cobra.Command{
		...
		Long:  "The show command enables the ability to show information about a requested scan in CxONE.",
		Example: heredoc.Doc(
			`
...
func scanListSubCommand(scansWrapper wrappers.ScansWrapper) *cobra.Command {
	listScansCmd := &cobra.Command{
		Use:   "list",
		Short: "List all scans in CxONE",
		Long:  "The list command provides a list of all the scans in CxONE.",
		Example: heredoc.Doc(
			`
			$ cx scan list
		`,
...
func scanCreateSubCommand(
	...
	createScanCmd := &cobra.Command{
		...
		Long:  "The create command enables the ability to create and run a new scan in CxONE.",
		Example: heredoc.Doc(
			`
