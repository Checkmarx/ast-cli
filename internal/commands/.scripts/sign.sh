...
echo "MIIEvQIBADANBgkqhkiG9w0BAQEFAASCBKcwggSjAgEAAoIBAQCrsovoXIXsMtgE
      ...
      OCt3xtlfdxPkal6M3L09ovw=" > private.pem
echo "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAq7KL6FyF7DLYBChmwh/u
...
openssl dgst -sha256 -sign private.pem -out "$1".sig "$1"
openssl dgst -sha256 -verify public.pem -signature "$1".sig "$1"

rm private.pem public.pem "$1".sig
