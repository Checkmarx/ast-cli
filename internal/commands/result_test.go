...
func TestRunGetResultsByScanIdJsonFormatWithPrioritizeSast(t *testing.T) {
	execCmdNilAssertion(t, "results", "show", "--scan-id", "MOCK", "--report-format", "json", "--prioritize-sast")
