...
func TestAddDescriptionForIdentifiers(t *testing.T) {
	...
	expected := fmt.Sprintf(expectedOutputFormat, " 35 ", " this is a short explanation.", " a fixed snippet")
...
func TestAddNewlinesIfNecessarySomeNewlines(t *testing.T) {
	...
	expected := fmt.Sprintf(expectedOutputFormat, " 35 ", " this is a short explanation.\n", " a fixed snippet")
...
func TestAddNewlinesIfNecessaryAllNewlines(t *testing.T) {
	...
	expected := fmt.Sprintf(expectedOutputFormat, " 35\n ", " this is a short explanation.\n", " a fixed snippet")
