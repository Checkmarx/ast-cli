...
//	commands.execCmdNilAssertion(t, "import", "--project-name", "my-project", "--import-file-path", "my-path.sarif")
//}
//
//func TestImport_ImportSarifFileProjectDoesntExist_CreateImportWithProvidedNewNameSuccessfully(t *testing.T) {
//	wrappers.FeatureFlags[featureFlagsConstants.ByorEnabled] = true
//	commands.execCmdNilAssertion(t, "import", "--project-name", "MOCK-PROJECT-NOT-EXIST", "--import-file-path", "my-path.sarif")
//}
//
//func TestImport_ImportSarifFileMissingImportFilePath_CreateImportReturnsErrorWithCorrectMessage(t *testing.T) {
//	wrappers.FeatureFlags[featureFlagsConstants.ByorEnabled] = true
//	err := commands.execCmdNotNilAssertion(t, "import", "--project-name", "my-project")
...
//	wrappers.FeatureFlags[featureFlagsConstants.ByorEnabled] = true
//	err := commands.execCmdNotNilAssertion(t, "import", "--project-name", "my-project", "--import-file-path", "")
//	assert.Assert(t, err.Error() == errorConstants.ImportFilePathIsRequired)
//}
//
//func TestImport_ImportSarifFileMissingImportProjectName_CreateImportReturnsErrorWithCorrectMessage(t *testing.T) {
//	wrappers.FeatureFlags[featureFlagsConstants.ByorEnabled] = true
//	err := commands.execCmdNotNilAssertion(t, "import", "--import-file-path", "my-path.zip")
...
//	wrappers.FeatureFlags[featureFlagsConstants.ByorEnabled] = true
//	err := commands.execCmdNotNilAssertion(t, "import", "--project-name", "", "--import-file-path", "my-path.sarif")
//	assert.Assert(t, err.Error() == errorConstants.ProjectNameIsRequired)
//}
//
//func TestImport_ImportSarifFileUnacceptedFileExtension_CreateImportReturnsErrorWithCorrectMessage(t *testing.T) {
//	wrappers.FeatureFlags[featureFlagsConstants.ByorEnabled] = true
//	err := commands.execCmdNotNilAssertion(t, "import", "--project-name", "MOCK-PROJECT-NOT-EXIST", "--import-file-path", "my-path.txt")
...
//	wrappers.FeatureFlags[featureFlagsConstants.ByorEnabled] = true
//	err := commands.execCmdNotNilAssertion(t, "import", "--project-name", "MOCK-PROJECT-NOT-EXIST", "--import-file-path", "some/path/no/extension/my-path")
//	assert.Assert(t, err.Error() == errorConstants.SarifInvalidFileExtension)
//}
//
