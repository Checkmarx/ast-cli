...
var EnvVarsBinds = []struct {
	...
	{ScaResultsPredicatesPathKey, ScaResultsPredicatesPathEnv, "api/sca/management-of-risk/package-vulnerabilities"},
	...
	{EnvironmentsPathKey, EnvironmentsPathEnv, "api/dast/scans/environments"},
