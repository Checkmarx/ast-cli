...
func createScan(t *testing.T, source string, tags map[string]string) (string, string) {
	if isFFEnabled(t, wrappers.ContainerEngineCLIEnabled) {
		return executeCreateScan(t, getCreateArgs(source, tags, "sast , sca , api-security, scs, container-security"))
	} else {
		return executeCreateScan(t, getCreateArgs(source, tags, "sast , sca , api-security , scs"))
	}
}
