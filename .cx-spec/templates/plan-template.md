...
**Note**: This template is filled in by the `/cx-spec.plan` command. See `.cx-spec/templates/commands/plan.md` for the execution workflow.
...
```text
specs/[###-feature]/
├── plan.md              # This file (/cx-spec.plan command output)
├── research.md          # Phase 0 output (/cx-spec.plan command)
├── data-model.md        # Phase 1 output (/cx-spec.plan command)
├── quickstart.md        # Phase 1 output (/cx-spec.plan command)
├── contracts/           # Phase 1 output (/cx-spec.plan command)
└── tasks.md             # Phase 2 output (/cx-spec.tasks command - NOT created by /cx-spec.plan)
```
